...
| declared hardened affected-level contradiction-audit coverage and local-tightening registration over the registered affected set | pass | `ROOT-011`, `EVID-ROOT-011` |
...
| registered constitutional package contradiction-audit coverage and package-truth registration | pass | `ROOT-014`, `EVID-ROOT-014` |
| registered root package contradiction-audit coverage and package-truth registration | pass | `ROOT-015`, `EVID-ROOT-015` |
