...
## Inputs
- declared package and contract versions only
...
This layer expresses version fact only. It never publishes editor workflow state or hidden execution runtime.
