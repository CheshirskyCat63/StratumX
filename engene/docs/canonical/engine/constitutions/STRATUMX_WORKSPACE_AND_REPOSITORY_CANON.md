...
- root docs define stack identity and summary maps;
...
`engine_startup` remains above runtime family and does not merge with runtime or service layers.
...
- `docs/canonical/engine/` root canon
